		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="capnhatsanpham" value="Cập nhật" class="btn btn-default" style="background:#07F;color:#fff;width:120px;height:35px;">
				</form>
				</div>
			<?php
			}else{
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="themsanpham" value="Thêm" class="btn btn-default" style="background:#07F;color:#fff;width:100px;height:35px;">
				</form>
				</div>
				<?php
			} 
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a href="?xoa=<?php echo $row_sp['sanpham_id'] ?>"><img src="../images/delete.png" width="30" height="30" /></a> </td>
						<td> <a href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>"><img src="../images/edit.png" width="30" height="30" /></a></td>
					</tr>
				<?php
					} 
					?> 
