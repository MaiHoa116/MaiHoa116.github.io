	...
	<div class="container">
		<div class="row">
			...
			<?php
				...
				<label>Tên chủ đề</label>
				<form action="" method="POST">
					<input type="text" class="form-control" name="danhmuc" placeholder="Tên chủ đề"><br>
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>"><img src="../images/delete.png" width="30" height="30" /></a> </td>
						<td> <a href="?quanly=capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>"><img src="../images/edit.png" width="30" height="30" /></a></td>
					</tr>
					<?php
					} 
					?>
